                ...
                return (
                  <li key={project.filename}>
                    ...
                    <Link href={`/projects/${project.slug}`}>
                      <div className="flex flex-col md:flex-row md:gap-8 hover:bg-white/5 group my-4 group transition-all duration-200 rounded-3xl p-5">
                        <div
                          className={`flex w-full h-[220px] md:h-[200px] md:max-w-[300px] border border-white/5 justify-center ${project.bgColor} rounded-xl mb-4 md:mb-0`}
                        >
                          <Image
                            src={project.src}
                            alt={project.title}
