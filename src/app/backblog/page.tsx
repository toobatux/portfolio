                  ...
                  <div className="mb-6 lg:mb-8">
                    ...
                    <div className="h-full bg-white/5 p-5 rounded-xl text-gray-300">
                      <p className="block mb-4">
                        ...
                        independently developed for both iOS and Android
                        devices.
                      </p>
                      <p className="block mb-2 text-lg font-semibold">
                        System:
                      </p>
                      <p className="block mb-2">
                        The app was developed for Android devices using Kotlin
                        and Jetpack Compose, while iOS used Swift and SwiftUI
                      </p>
                      <p className="block mb-2">
                        Firebase is used to store users, logs, and friendships.
                      </p>
                      <p className="block mb-2">
                        The Movie Database (TMDB) provides data for thousands of
                        movies.
                      </p>
                      <p className="block mb-4">
                        The app operates seamlessly between iOS and Android
                        devices.
                      </p>
                      <p className="block mb-2 text-lg font-semibold">
                        Users can:
