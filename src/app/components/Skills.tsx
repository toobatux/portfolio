    ...
    <>
      <div className="mb-8 lg:mb-12">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          <div className="bg-white/5 rounded-lg p-2">
            <div className="flex items-center p-2">
              <div className="bg-orange-600 rounded-lg p-1 me-2 bg-opacity-20">
                <svg
              ...
              <div className="text-gray-200">HTML</div>
            </div>
          </div>

          <div className="bg-white/5 rounded-lg p-2">
            <div className="flex items-center p-2">
              <div className="bg-blue-600 rounded-lg p-1 me-2 bg-opacity-20">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <div className="text-gray-200">CSS</div>
            </div>
          </div>

          <div className="bg-white/5 rounded-lg p-2">
            <div className="flex items-center p-2">
              <div className="bg-yellow-600 rounded-lg p-1 me-2 bg-opacity-20">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <div className="text-gray-200">JavaScript</div>
            </div>
          </div>
          <div className="bg-white/5 rounded-lg p-2">
            <div className="flex items-center p-2">
              <div className="bg-indigo-600 rounded-lg p-1 me-2 bg-opacity-20">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <div className="text-gray-200">Bootstrap</div>
            </div>
          </div>
          <div className="bg-white/5 rounded-lg p-2">
            <div className="flex items-center p-2">
              <div className="bg-cyan-600 rounded-lg p-1 me-2 bg-opacity-20">
                <svg
                  viewBox="0 0 32 32"
                  width="24"
                  height="24"
              ...
              <div className="text-gray-200">Tailwind</div>
            </div>
          </div>
          <div className="bg-white/5 rounded-lg p-2">
            <div className="flex items-center p-2">
              ...
              <div className="text-gray-200">React</div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          <div className="bg-white/5 rounded-lg p-2">
            <div className="flex items-center p-2">
              <div className="bg-sky-600 rounded-lg p-1 me-2 bg-opacity-20">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <div className="text-gray-200">Python</div>
            </div>
          </div>
          <div className="bg-white/5 rounded-lg p-2">
            <div className="flex items-center p-2">
              <div className="bg-neutral-400 rounded-lg p-1 me-2 bg-opacity-20">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 256 256"
                  version="1.1"
              ...
              <div className="text-gray-200">NextJS</div>
            </div>
          </div>

          <div className="bg-white/5 rounded-lg p-2">
            <div className="flex items-center p-2">
              <div className="bg-green-700 rounded-lg p-1 me-2 bg-opacity-20">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="text-gray-200">Django</div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-white/5 rounded-lg p-2">
            <div className="flex items-center p-2">
              <div className="bg-purple-600 rounded-lg p-1 me-2 bg-opacity-20">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
          ...
          <div className="bg-white/5 rounded-lg p-2">
            <div className="flex items-center p-2">
              ...
              <div className="text-gray-200">Git</div>
            </div>
          </div>
          <div className="bg-white/5 rounded-lg p-2">
            <div className="flex items-center p-2">
              ...
              <div className="text-gray-200">VS Code</div>
            </div>
          </div>
        </div>
      </div>
