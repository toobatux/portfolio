      ...
      <div className="mb-12">
        ...
        <div className="flex gap-1">
          <Link
            ...
            prefetch={false}
          >
            <div className="backdrop-blur-lg rounded-xl p-2 hover:bg-white/5 transition-all">
          ...
          <Link href="mailto:krusinskithomas@gmail.com" prefetch={false}>
            <div className="relative backdrop-blur-lg rounded-xl p-2 hover:bg-white/5 transition-all">
              <div className="flex items-center p-1">
                <div className="p-1">
                  <Mail className="text-neutral-200" />
                </div>
