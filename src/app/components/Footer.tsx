  ...
  return (
    <div className="w-full bg-black border-t border-white/10">
      ...
      <div className="flex w-full justify-center items-center">
        <div className="flex-col w-full max-w-7xl items-center py-12 px-8 lg:px-12 transition-all">
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  <svg
                    ...
                    height="20"
                    viewBox="0 0 24 24"
                    className="fill-white/80 hover:fill-white/85"
                  >
                ...
                <Link href="mailto:krusinskithomas@gmail.com" prefetch={false}>
                  <Mail className="text-white/80 hover:fill-white/85" />
                </Link>
              </div>
            </div>
