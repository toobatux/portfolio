      ...
      <div className="flex max-h-36 border border-white/10 shadow-xl overflow-hidden bg-white/5 backdrop-blur-3xl group transition-colors duration-200 rounded-[24px] p-5">
        <div className="flex items-center w-full">
          ...
          <div className="flex flex-col">
            <p className=" text-white/65">Top Song of 2024</p>
            <p className="block text-white text-base font-medium group-hover:underline">
              {title}
            </p>
            <p className=" text-white/65">{artist}</p>
          </div>
        </div>
